...
const localization: LocalizationKeys = {
  ...
  inputStyleLabel: {en: "Input style", uk: "Стиль полів"},
  inputStyleBoxed: {en: "Boxed", uk: "Рамка"},
  inputStyleStepper: {en: "Stepper −/+", uk: "Крок −/+"},
  inputStyleScrubber: {en: "Scrubber", uk: "Скраб"},
  inputStyleChips: {en: "Chips", uk: "Чіпи"},
  scrubHint: {en: "drag ↔ or type", uk: "тягніть ↔ або введіть"},
  stepDownLabel: {en: "Decrease", uk: "Зменшити"},
  stepUpLabel: {en: "Increase", uk: "Збільшити"},
