...
const toggleDaisyUITheme = () => {
  ...
  // Set the next theme in ThemeManager to update the theme index
...
function applyTheme(theme: string) {
  ...
  // Update the theme toggle button text to reflect the current theme
...
export function toggleLanguage(): void {
  ...
  // Update UI elements to reflect the new language
  updateLanguageUI();
}
