...
2.  **Попереднє чищення (Hard Outliers)**: Вилучаються занадто швидкі або занадто повільні реакції, що виходять за межі фізіологічно можливих (за замовчуванням: <100 мс або >500 мс).
